...
double getNTPTime()
{
  int sockfd, n;
  int portno = 123;
  const char* host_name = "0.de.pool.ntp.org";
  ...
  double txTm = packet.txTm_s - NTP_TIMESTAMP_DELTA;
  double frac = ((double)packet.txTm_f) / NTP_MAX_INT_AS_DOUBLE ; // 2^32 -1
